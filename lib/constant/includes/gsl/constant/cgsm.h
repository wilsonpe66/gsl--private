...
constexpr auto BOHR_MAGNETON = 9.27400899e-21;             // abamp cm^2
constexpr auto NUCLEAR_MAGNETON = 5.05078317e-24;          // abamp cm^2
constexpr auto ELECTRON_MAGNETIC_MOMENT = 9.28476362e-21;  // abamp cm^2
constexpr auto PROTON_MAGNETIC_MOMENT = 1.410606633e-23;   // abamp cm^2
...
constexpr auto FARADAY = 9.6485341472e3;                   // abamp s / mol
constexpr auto ELECTRON_CHARGE = 1.602176462e-20;          // abamp s
constexpr auto GAUSS = 1e0;                                // g / abamp s^2
...
constexpr auto ROENTGEN = 2.58e-8;                         // abamp s / g
